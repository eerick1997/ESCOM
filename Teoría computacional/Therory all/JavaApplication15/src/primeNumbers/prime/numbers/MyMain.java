package primeNumbers.prime.numbers;

import primeNumbers.Graph.Graph;
...
public class MyMain {
    ...
    void manual(BigInteger limit) {
        ...
        oneSeries.add(0,0);
        try {
            FileWriter fileWriter = new FileWriter("primes/Primes.txt");
            fileWriter.write("\u03A3 = {");
    ...
    void showGraph(XYSeries onesSerie) {
        ...
        jlabel = new JLabel();
        jframe = new JFrame();
        jframe.setSize(1700, 1020);
        jpanel.setSize(1700, 1020);
