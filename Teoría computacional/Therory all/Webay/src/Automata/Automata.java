...
public class Automata {
    ...
    private static final String FILE_TRANS = "transitions.txt", FILE_WORDS = "words.txt";
    ...
    public String states(char character, String actualState, int NLine, int NWord) {
        ...
        if (actualState.equals(q3)) {
            //System.out.println("I'm in q3 and I'm in line: " + NLine + " and I'm the word number: " + NWord + "  " + strWeb);
