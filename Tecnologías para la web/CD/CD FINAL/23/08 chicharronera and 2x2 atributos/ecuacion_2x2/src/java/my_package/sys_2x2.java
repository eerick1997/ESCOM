    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (A_1 == 0 || B_1 == 0 || A_2 == 0 || B_2 == 0) {
                out.println("<h1>Hay soluciones infinitas o bien todos los coeficientes son cero</h1>");
                session.setAttribute("clave_X", "Hay soluciones infinitas o bien todos los coeficientes son cero");
            } else {
                ...
                if (determinante_X1 != 0 || determinante_Y1 != 0) {
                    ...
                    out.println("<br/>");
                    out.println("<h1> Y = " + determinante_Y1 / determinante + " </h1>");
                    session.setAttribute("clave_X", " X = " + determinante_X1 / determinante);
                    session.setAttribute("clave_Y", " Y = " + determinante_Y1 / determinante);
                } else {
                    out.println("<h1>Indefinido</h1>");
                    session.setAttribute("clave_X", "Indefinido");
                    session.setAttribute("clave_Y", "");
                }
            ...
            session.setAttribute("clave_X", "Eso no es un numero");
            session.setAttribute("clave_Y", "");
        }
    }
