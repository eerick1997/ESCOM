...
void NewRightSon(arbol_binario a,elemento e)
{
	/**if(Empty(a))
	{
...
void NewLeftSon(arbol_binario a,elemento e)
{
	/**if(Empty(a))
	{
		*a=malloc(sizeof(nodo));
...
void ReplaceElement(arbol_binario a,elemento e)
{
    a->e = e;
	return;
}
